                        ...
                        <?php if($result){ 
                          ...
                          ?>  
                            <tr>
                              ...
                              <td><?= $item['total_character'] ?></td>
                              <td><?= $item['correct_character'] ?></td>
                              <td><?= $item['wrong_character'] ?></td>
                              <td><?= $item['finsh_time'] ?>sec</td>
                              <td><?= $item['acuracy'] ?>%</td>
                              <td><?= $item['status'] ?></td>
                              <td><a href="<?= base_url('show-grapgh/').$item['id'] ?>" class="btn btn-success" title="Show"><i class="nav-icon fas fa-eye"></i></a></td>
