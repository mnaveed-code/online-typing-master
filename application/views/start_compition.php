    ...
    let stats = 'Null';
            ...
            function checkinput(userinput){
                if(userinput == lw[count]){
                    ...
                    base_url = "http://localhost/typing/";
                    $.ajax({
                        url: base_url+"progres_status", 
                        type: "post",    
                        dataType: 'json',
                        ...
                        success:function(result){
                            ...
                            function myFunction(item, index, arr) {
                             var aa =  (item.correct_character/lw.length)*100; 
                             aa = aa.toString().split(".")[0];
                             progress =  progress + "<div> "+ item.first_name +"</div> <div id='progress' class='progress-bar' role='progressbar' style='width:" + aa + "%; background-color:green;' aria-valuenow='"+ aa +"' aria-valuemin='0' aria-valuemax='100'>" + aa + "% </div> <br>" ;
                ...
                //     location.href = 'http://localhost/typing/user/compition';
                // }
                ...
                if(count == lw.length){
                    ...
                    location.href = 'http://localhost/typing/compition/result';
                }
            }
            ...
            function stop(){
                    ...
                    $.ajax({
                        ...
                        location.href = 'http://localhost/typing/test/result_show';
            }
