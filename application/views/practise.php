  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"> All Leason</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item"><a href="#">All leason</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                  ...
                  <table class="table table-striped responsive-table">
                      ...
                      <?php if($tests){ 
                          ...
                          <tr>
                            ...
                            <td><a href="<?= base_url('start_practise/').$item['id'] ?>" class="btn btn-success" title="Start">Start </a></td>
                          </tr>
                          <?php } 
                                        } ?>
                      </tbody>
